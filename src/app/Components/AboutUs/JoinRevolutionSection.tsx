      ...
      <div className="max-w-[1320px] mx-auto  py-10 lg:py-15 flex gap-x-16 justify-between items-center flex-col lg:flex-row px-4 my-15 lg:my-25">
        <div className="flex-1">
          <div>
            ...
            <div className="mb-12">
              <h1
                className={`font-[700] lg:text-[48px] text-white! text-2xl my-4 flex justify-center flex-col text-center  font-[Sofia_Sans]`}
              >
                <span className=" text-[rgba(76,206,238,1)]!">
                  Join the AI Revolution in
                </span>{" "}
                Blockchain Security and Automation
              </h1>
