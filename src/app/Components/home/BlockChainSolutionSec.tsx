    ...
    <section className="pt-25 py-10">
      ...
      <div>
        ...
        <div className="mb-12">
          ...
          />
          <h1
            className={`font-bold text-2xl md:text-[48px] my-3 md:my-4 flex flex-col sm:flex-row justify-center text-center gap-2 text-[rgba(76,206,238,1)] font-[Sofia_Sans]`}
          >
